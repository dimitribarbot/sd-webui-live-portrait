...
class InferenceConfig(PrintableConfig):
    ...
    checkpoint_F: str = os.path.join(models_path, 'liveportrait', 'base_models', 'appearance_feature_extractor.safetensors')  # path to checkpoint of F
    checkpoint_M: str = os.path.join(models_path, 'liveportrait', 'base_models', 'motion_extractor.safetensors')  # path to checkpoint of M
    checkpoint_G: str = os.path.join(models_path, 'liveportrait', 'base_models', 'spade_generator.safetensors')  # path to checkpoint of G
    checkpoint_W: str = os.path.join(models_path, 'liveportrait', 'base_models', 'warping_module.safetensors')  # path to checkpoint of W
